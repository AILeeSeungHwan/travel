...
export default function Terms() {
  return (
    <Layout title="이용약관" description="여행모아 이용약관. 사이트 이용 시 적용되는 일반 조건을 안내합니다.">
      ...
      <div style={{ fontSize:15, lineHeight:1.85, color:'#334155' }}>
        ...
        <p>본 약관은 여행모아 사이트(이하 "본 사이트") 이용에 관한 일반 조건을 정합니다.</p>
        ...
        <p>본 사이트의 자체 작성 콘텐츠 저작권은 여행모아에 귀속됩니다. 외부 출처(한국관광공사·Wikimedia·Unsplash·Pexels·호텔스컴바인 API)에서 가져온 이미지는 각 라이선스(공공누리·CC·파트너 약관)에 따라 표시됩니다. 자세한 내역은 <a href="/image-credits/" style={{ color:'#0369A1' }}>이미지 출처 페이지</a>에서 확인할 수 있습니다. 무단 복제·전재를 금합니다.</p>
