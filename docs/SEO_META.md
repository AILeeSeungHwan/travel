# SEO_META.md — 트립스팟 SEO 규칙

## 메타 패턴

| 페이지 | Title (60자 이하) |
|---|---|
| 국가 | `{국가명} 여행 가이드 — 비자·시즌·추천 도시 — 트립스팟` |
| 지역 | `{지역명} 여행 — 가볼 만한 곳·호텔 추천 — 트립스팟` |
| 스팟 | `{스팟명} ({지역명}) — 입장료·가는 법·주변 호텔 — 트립스팟` |
| 호텔 | `{호텔명} — 위치·시설·평점 — 트립스팟` |
| 테마 | `{테마명} 추천 — 베스트 BEST {n} — 트립스팟` |
| 가이드 | `{가이드명} — 출국 전 필수 안내 — 트립스팟` |
...
Sitemap: https://tripspot.ambitstock.com/sitemap.xml
```
